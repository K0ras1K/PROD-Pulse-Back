...
class RemoveFriendTest {
    ...
    @Test
    fun removeFriendTest() = testApplication {
        ...
        val second_remove_friend_response = client.post("/api/friends/remove") {
            contentType(ContentType.Application.Json)
        ...
        assertEquals(HttpStatusCode.OK, second_remove_friend_response.status)
    }
