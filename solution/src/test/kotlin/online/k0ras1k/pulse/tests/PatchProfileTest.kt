...
class PatchProfileTest {
    ...
    @Test
    fun testPatchProfile() = testApplication {
        ...
        val patch_response = client.patch("/api/me/profile") {
            contentType(ContentType.Application.Json)
        ...
        println(patch_response.bodyAsText())
        assertEquals(HttpStatusCode.OK, patch_response.status)
